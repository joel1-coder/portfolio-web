...
const projectsData = [
  {
    ...
    desc: 'A full-stack MERN attendance management system replacing manual registers for college CS lab staff. Features JWT-based role authentication with separate Admin and Staff portals and protected API routes.',
  ...
  {
    name: 'BPC — Canteen Management',
    desc: 'A full-stack canteen management platform with three role-based portals — Admin, Operator, and Public. Features RESTful APIs for menu management, staff scheduling, billing transactions, and student discount offers.',
    stack: ['React.js', 'Node.js', 'Express.js', 'MongoDB'],
    emoji: '🍽️',
  ...
  },
  {
    ...
    desc: 'An institutional room booking system with admin approval workflow, real-time slot availability indicators, and in-app notification for booking status updates. Features dynamic unique formatted IDs and SheetJS Excel export.',
    stack: ['React.js', 'Node.js', 'Express.js', 'MongoDB'],
    emoji: '🏛️',
  ...
  {
    name: 'Notivo — Task & Workflow',
    desc: 'A full-stack MERN admin dashboard for task management, form building, and user submission tracking. Features JWT auth with role-based access control, centralized Axios API service layer, and dynamic form template builder with reusable template storage.',
    stack: ['React.js', 'Node.js', 'Express.js', 'MongoDB'],
    emoji: '📋',
